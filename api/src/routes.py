...
def workouts_reload():
    ...
    if (reload_db == True):
        ...
        try:
            ...
            x = db.workouts.insert_one({"type": "Fishing", "METs": "2.5", "Equipment": "Fishing rod"})
            x = db.workouts.insert_one({"type": "Cleaning", "METs": "5.0", "Equipment": None})
            x = db.workouts.insert_one({"type": "Mowing lawn", "METs": "6.0", "Equipment": None})
            x = db.workouts.insert_one({"type": "Badminton", "METs": "8.0", "Equipment": "Badminton racket"})
            x = db.workouts.insert_one({"type": "Jogging at 6 mph", "METs": "8.0", "Equipment": None})
            x = db.workouts.insert_one({"type": "Shoveling", "METs": "7.8", "Equipment": "Shovel"})
            x = db.workouts.insert_one({"type": "Carrying heavy loads", "METs": "9.9", "Equipment": None})
            x = db.workouts.insert_one({"type": "Soccer", "METs": "9.6", "Equipment": "Soccer"})
            ...
            x = db.workouts.insert_one({"type": "weight lifting", "METs": "3.0", "Equipment": None})
            x = db.workouts.insert_one({"type": "whirlpool", "METs": "1.0", "Equipment": "whirlpool"})
            x = db.workouts.insert_one({"type": "ballet or modern", "METs": "4.8", "Equipment": None})
            x = db.workouts.insert_one({"type": "aerobic, general", "METs": "6.5", "Equipment": None})
            x = db.workouts.insert_one({"type": "aerobic, step, with 6 – 8 inch step", "METs": "8.5", "Equipment": None})
            x = db.workouts.insert_one({"type": "aerobic, step, with 10 – 12 inch step", "METs": "10.0", "Equipment": None})
            x = db.workouts.insert_one({"type": "aerobic, low impact", "METs": "5.0", "Equipment": None})
            x = db.workouts.insert_one({"type": "aerobic, high impact", "METs": "7.0", "Equipment": None})
            x = db.workouts.insert_one({"type": "digging worms, with shovel", "METs": "4.0", "Equipment": "Shovel"})
            x = db.workouts.insert_one({"type": "fishing from river bank and walking", "METs": "4.0", "Equipment": "boat"})
            x = db.workouts.insert_one({"type": "fishing from boat, sitting", "METs": "2.5", "Equipment": "Fishing rod"})
            x = db.workouts.insert_one({"type": "fishing from river bank, standing", "METs": "3.5", "Equipment": "Fishing rod"})
            x = db.workouts.insert_one({"type": "fishing in stream, in waders", "METs": "6.0", "Equipment": "Fishing rod"})
            x = db.workouts.insert_one({"type": "fishing, ice, sitting", "METs": "2.0", "Equipment": "Fishing rod"})
            x = db.workouts.insert_one({"type": "wash dishes - standing or in general", "METs": "2.3", "Equipment": None})
            x = db.workouts.insert_one({"type": "wash dishes; clearing dishes from table – walking", "METs": "2.5", "Equipment": None})
            x = db.workouts.insert_one({"type": "bowling", "METs": "3.0", "Equipment": "Bowling course"})
            x = db.workouts.insert_one({"type": "boxing, in ring, general", "METs": "12.0", "Equipment": "Bike"})
            x = db.workouts.insert_one({"type": "boxing, punching bag", "METs": "6.0", "Equipment": "sandbag"})
            x = db.workouts.insert_one({"type": "broomball", "METs": "7.0", "Equipment": "Ice ground"})
            ...
            x = db.workouts.insert_one({"type": "horseback riding, saddling horse", "METs": "3.5", "Equipment": "horse"})
            ...
            x = db.workouts.insert_one({"type": "rock climbing, ascending rock", "METs": "11.0", "Equipment": "Climbing Rope"})
            x = db.workouts.insert_one({"type": "rock climbing, rappelling", "METs": "8.0", "Equipment": "Junping Rope"})
            x = db.workouts.insert_one({"type": "rope jumping, fast", "METs": "12.0", "Equipment": "Junping Rope"})
            x = db.workouts.insert_one({"type": "rope jumping, moderate, general", "METs": "10.0", "Equipment": "Junping Rope"})
            x = db.workouts.insert_one({"type": "rope jumping, slow", "METs": "8.0", "Equipment": "Junping Rope"})
            ...
            x = db.workouts.insert_one({"type": "skating, roller", "METs": "7.0", "Equipment": "ski"})
            x = db.workouts.insert_one({"type": "sky diving", "METs": "3.5", "Equipment": "parachute"})
            x = db.workouts.insert_one({"type": "soccer, competitive", "METs": "10.0", "Equipment": "soccer"})
            x = db.workouts.insert_one({"type": "soccer, casual, general ", "METs": "7.0", "Equipment": "soccer"})
            x = db.workouts.insert_one({"type": "softball or baseball, fast or slow pitch, general ", "METs": "5.0", "Equipment": "softball"})
            ...
            x = db.workouts.insert_one({"type": "table tennis, ping pong", "METs": "8.0", "Equipment": "ping-pong ball"})
            x = db.workouts.insert_one({"type": "tennis, general", "METs": "7.0", "Equipment": "tenis racket"})
            x = db.workouts.insert_one({"type": "tennis, doubles", "METs": "6.0", "Equipment": "tenis racket"})
            x = db.workouts.insert_one({"type": "volleyball", "METs": "4.0", "Equipment": "volleyball"})
            x = db.workouts.insert_one({"type": "volleyball, competitive", "METs": "8.0", "Equipment": "volleyball"})
            ...
            x = db.workouts.insert_one({"type": "wrestling", "METs": "8.0", "Equipment": None})
            ...
            x = db.workouts.insert_one({"type": "sailing, boat and board sailing, windsurfing, ice sailing, genera", "METs": "3.0", "Equipment": "ship"})
            ...
            x = db.workouts.insert_one({"type": "skiing, general", "METs": "8.0", "Equipment": "Bike"})
            x = db.workouts.insert_one({"type": "skiing, cross country, 2.5 mph, slow or light effort, ski walking", "METs": "7.0", "Equipment": "ski"})
            x = db.workouts.insert_one({"type": "skiing, cross country, 4.0-4.9 mph, moderate speed and effort", "METs": "8.0", "Equipment": "ski"})
            x = db.workouts.insert_one({"type": "skiing, cross country, 5.0-7.9 mph, brisk speed,", "METs": "9.0", "Equipment": "ski"})
